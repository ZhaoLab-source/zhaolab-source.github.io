...
::: {.member-grid}
::: {.member-card}
![Shaoling Zhao](images/ShaolingZhao.jpg){.member-avatar alt="Shaoling Zhao"}
Shaoling Zhao, PhD
...
::: {.member-grid}
::: {.member-card}
![Liang Yue](images/LiangYue.jpg){.member-avatar alt="Liang Yue"}
Liang Yue, PhD
...
::: {.member-grid}
::: {.member-card}
![Quanhao Yu](images/QuanhaoYu.jpg){.member-avatar alt="Quanhao Yu"}
Quanhao Yu
<div class="member-email"><a href="mailto:yqh847438584@126.com">yqh847438584@126.com</a></div>
<div class="member-role">PhD Student · interested in reward process</div>
:::
::: {.member-card}
![Xinyuan Zhang](images/XinyuanZhang.jpg){.member-avatar alt="Xinyuan Zhang"}
Xinyuan Zhang
<div class="member-email"><a href="mailto:xinyuanz11@163.com">xinyuanz11@163.com</a></div>
<div class="member-role">PhD Student · interested in mechanism of addiction and neuromodulation</div>
:::
::: {.member-card}
![Yihan Yan](images/YihanYan.jpg){.member-avatar alt="Yihan Yan"}
Yihan Yan
<div class="member-email"><a href="mailto:y9946h@sjtu.edu.cn">y9946h@sjtu.edu.cn</a></div>
<div class="member-role">PhD Student · interested in large-scale brain network analysis</div>
:::
::: {.member-card}
![Mengting (Vicky) Shen](images/MengtingShen.jpg){.member-avatar alt="Mengting (Vicky) Shen"}
Mengting (Vicky) Shen
...
:::
::: {.member-card}
![Xinyi (Kathryn) Zhou](images/XinyiZhou.jpg){.member-avatar alt="Xinyi (Kathryn) Zhou"}
Xinyi (Kathryn) Zhou
...
::: {.member-grid}
::: {.member-card}
![Yutong Li](images/YutongLi.jpg){.member-avatar alt="Yutong Li"}
Yutong Li
<div class="member-email"><a href="mailto:yutongli@sjtu.edu.cn">yutongli@sjtu.edu.cn</a></div>
<div class="member-role">Master Student · interested in computational psychiatry</div>
:::
::: {.member-card}
![Keyi Zhang](images/KeyiZhang.jpg){.member-avatar alt="Keyi Zhang"}
Keyi Zhang
<div class="member-email"><a href="mailto:kevinzhangkeyi@gmail.com">kevinzhangkeyi@gmail.com</a></div>
<div class="member-role">Master Student · interested in time perception</div>
:::
::: {.member-card}
![Yuqiao Cai](images/YuqiaoCai.jpg){.member-avatar alt="Yuqiao Cai"}
Yuqiao Cai
...
::: {.member-grid}
::: {.member-card}
![Zhenhua Cui](images/ZhenhuaCui.jpg){.member-avatar alt="Zhenhua Cui"}
Zhenhua Cui
